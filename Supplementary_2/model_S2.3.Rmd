---
title: "Controlled recombination simulation, biparental model analysis, cycle 6"
...
<details><summary>Click here:  Model, ANOVA tables cycle 6</summary>
...
<details><summary>Click here: Cycle 6, best and worst simulation parameter prediction summaries</summary>
#### Cycle 6, WT map  

```{r, echo=FALSE, message=FALSE}
response_6 <- emmeans(my_lmer_6, ~ Recombination+QTL+H2+Repulsion+Matrix | Map_type ) %>% tidy() %>% as.data.frame()

a = (response_6 %>% arrange(estimate) %>% 
  filter(Map_type == "WT") %>%
  arrange(-estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, top 10, cycle 6**"),
...
a = (response_6 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, worst 10, cycle 6**"),
      subtitle = md("**Map type:** WT")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
<details><summary>Click here: Click to expand: Cycle 6, best and worst simulation parameter prediction summaries</summary>
...
a = (response_6 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic variance estimates, top 10, cycle 6**"),
      subtitle = md("**Map type:** WT")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic variance estimates, worst 10, cycle 6**"),
      subtitle = md("**Map type:** WT")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Bulmer effect estimates, top 10, cycle 6**"),
      subtitle = md("**Map type:** WT")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Bulmer effect estimates, worst 10, cycle 6**"),
      subtitle = md("**Map type:** WT")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Prediction accuracy estimates, top 10, cycle 6**"),
      subtitle = md("**Map type:** WT")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Prediction accuracy estimates, worst 10, cycle 6**"),
      subtitle = md("**Map type:** WT")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
