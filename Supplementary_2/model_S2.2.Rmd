---
title: "Controlled recombination simulation, model analysis, cycle 10"
...
```{r, echo=FALSE, message=FALSE}
response_10 <- emmeans(my_lmer_10, ~ Recombination+QTL+H2+Repulsion+Matrix | Map_type + QTL_type) %>% tidy() %>% as.data.frame()
...
a = (response_10 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, top 2%, cycle 10**"),
...
a = (response_10 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, worst 2%, cycle 10**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_10 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic variance estimates, top 2%, cycle 10**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_10 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic variance estimates, worst 2%, cycle 10**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_10 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Bulmer effect estimates, top 2%, cycle 10**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_10 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Bulmer effect estimates, worst 2%, cycle 10**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_10 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Prediction accuracy estimates, top 2%, cycle 10**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_10 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Prediction accuracy estimates, worst 2%, cycle 10**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
