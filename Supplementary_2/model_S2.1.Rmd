---
title: "Controlled recombination simulation, model analysis, cycle 6"
...
**Linear model, ANOVA table, best and worst simulation parameters by genetic map and QTL type** 
...
response_6 <- emmeans(my_lmer_6, ~ Recombination+QTL+H2+Repulsion+Matrix | Map_type + QTL_type) %>% tidy() %>% as.data.frame() %>% as.data.frame()

a = (response_6 %>% arrange(estimate) %>% 
  filter(Map_type == "WT", QTL_type == "R") %>%
  arrange(-estimate) %>% 
  select(QTL, H2, Repulsion, Matrix, estimate, std.error, p.value) %>% 
  head(10) %>% 
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, top 2%, cycle 6**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
...
a = (response_6 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, worst 2%, cycle 6**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% arrange(estimate) %>% 
  filter(Map_type == "WT", QTL_type == "DV") %>%
  arrange(-estimate) %>% 
  select(QTL, H2, Repulsion, Matrix, estimate, std.error, p.value) %>% 
  head(10) %>% 
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, top 2%, cycle 6**"),
      subtitle = md("**Map type:** WT, **QTL type:** DV")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
```{r, echo=FALSE, message=FALSE}
response_6 <- emmeans(my_lmer_6, ~ Recombination+QTL+H2+Repulsion+Matrix | Map_type + QTL_type) %>% tidy() %>% as.data.frame()

a = (response_6 %>% arrange(estimate) %>% 
  filter(Map_type == "Peri", QTL_type == "R") %>%
  arrange(-estimate) %>% 
  ...
  tab_header(
      title = md("**Genetic gain estimates, top 2%, cycle 6**"),
      subtitle = md("**Map type:** Peri, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% arrange(estimate) %>% 
  filter(Map_type == "Peri", QTL_type == "DV") %>%
  arrange(-estimate) %>% 
  select(Recombination, QTL, H2, Repulsion, Matrix, estimate, std.error, p.value) %>% 
  head(10) %>% 
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, top 2%, cycle 6**"),
      subtitle = md("**Map type:** Peri, **QTL type:** DV")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% arrange(estimate) %>% 
  filter(Map_type == "Chr", QTL_type == "R") %>%
  arrange(-estimate) %>% 
  select(Recombination, QTL, H2, Repulsion, Matrix, estimate, std.error, p.value) %>% 
  head(10) %>% 
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, top 2%, cycle 6**"),
      subtitle = md("**Map type:** Chr, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% arrange(estimate) %>% 
  filter(Map_type == "Chr", QTL_type == "DV") %>%
  arrange(-estimate) %>% 
  select(Recombination, QTL, H2, Repulsion, Matrix, estimate, std.error, p.value) %>% 
  head(10) %>% 
  gt() %>% 
  tab_header(
      title = md("**Genetic gain estimates, top 2%, cycle 6**"),
      subtitle = md("**Map type:** Chr, **QTL type:** DV")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic variance estimates, top 2%, cycle 6**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Genetic variance estimates, worst 2%, cycle 6**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Bulmer effect estimates, top 2%, cycle 6**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Bulmer effect estimates, worst 2%, cycle 6**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% arrange(estimate) %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Prediction accuracy estimates, top 2%, cycle 6**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
a = (response_6 %>% 
  ...
  gt() %>% 
  tab_header(
      title = md("**Prediction accuracy estimates, worst 2%, cycle 6**"),
      subtitle = md("**Map type:** WT, **QTL type:** R")
    ))
gtsave(a, "table.png")
invisible(file.remove("table.png"))
...
```{r, echo=FALSE, message=FALSE}
response_10 <- emmeans(my_lmer, ~ Recombination+QTL+H2+Repulsion+Matrix+Allele | Map_type + QTL_type) %>% tidy() %>% as.data.frame()

response_10 %>% arrange(estimate) %>% 
  filter(Map_type == "WT", QTL_type == "R") %>%
  arrange(-estimate) %>% 
